<template>
  <section class="section">
    <div class="columns is-mobile">
      ...
      <SectionCode name="ElementOne" :code="ElementOneCode">
        <ElementOne></ElementOne>
      </SectionCode>


      <SectionCode name="ElementTwo" :code="ElementTwoCode">
        <ElementTwo></ElementTwo>
      </SectionCode>


      <SectionCode name="ElementThree" :code="ElementThreeCode">
        <ElementThree></ElementThree>
      </SectionCode>


      <SectionCode name="ElementFour" :code="ElementFourCode">
        <ElementFour></ElementFour>
      </SectionCode>


      <SectionCode name="ElementFive" :code="ElementFiveCode">
        <ElementFive></ElementFive>
      </SectionCode>


      <SectionCode name="ElementSix" :code="ElementSixCode">
        <ElementSix></ElementSix>
      </SectionCode>


      <SectionCode name="ElementSeven" :code="ElementSevenCode">
        <ElementSeven></ElementSeven>
      </SectionCode>


      <SectionCode name="ElementEight" :code="ElementEightCode">
